...
/**
 * Initialize Firebase Admin from env (no committed JSON).
 * Set FIREBASE_SERVICE_ACCOUNT_JSON (raw JSON string) or FIREBASE_CREDENTIAL_PATH (file path).
 */
function initFirebaseAdmin() {
  ...
  if (process.env.FIREBASE_SERVICE_ACCOUNT_JSON) {
    ...
    console.warn(
      "[firebase] Not configured (set FIREBASE_SERVICE_ACCOUNT_JSON or FIREBASE_CREDENTIAL_PATH) — push disabled"
    );
    return { firebase: null, configured: false };
  }
